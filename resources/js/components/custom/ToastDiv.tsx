...
export default function ToastDiv({ toastType, toastMessage, confirm, setShowConfirm, setConfirmDelete }: Props) {
    return (
        <div
            className={`fixed top-4 right-4 z-50 flex flex-col items-center gap-2 rounded-lg p-4 shadow-lg ${confirm ? 'bg-white' : toastType === 'success' ? 'bg-green-500 text-white' : 'bg-red-500 text-white'} animate-in fade-in slide-in-from-top-5`}
        >
